...
const effectsList = ["Angel Wings", "Halo", "Clock", "Music Notes", "Spotlight", "Sun", "MultiHearts", "Pumping Heart", "Stars", "Rose", "Gift", "Kiss", "Wand"];
...
function createCard(styles, mensaje, timestamp, id) {
	...
	actDiv.appendChild(timestampText);
